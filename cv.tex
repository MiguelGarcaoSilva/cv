...
\begin{itemize}[leftmargin=*, itemsep=1pt, topsep=0pt, partopsep=0pt]
  ...
  \item Published 6 first-author papers in top-quartile (Q1) scientific journals.
\end{itemize} \\
& \\[-6pt]
...
\textsc{2025} & \textbf{Motif Mining in Multivariate Time Series} \hfill \href{https://www.sciencedirect.com/science/article/pii/S0031320325005606\#sec5}{\textit{Pattern Recognition}} \enspace | \enspace \href{https://github.com/MiguelGarcaoSilva/motifsinresidual}{\texttt{GitHub}} \\[4pt]

\textsc{2025} & \textbf{Next-Motif: Predicting Irregular Pattern Recurrence in Time Series} \hfill \href{https://link.springer.com/chapter/10.1007/978-3-032-15535-1_2}{\textit{Springer (book chapter)}} \enspace | \enspace \href{https://github.com/MiguelGarcaoSilva/motifpred}{\texttt{GitHub}} \\[4pt]
...
\textsc{2023} & \textbf{Actionable descriptors of spatiotemporal urban dynamics from large-scale mobile data} \hfill \href{https://journals.sagepub.com/doi/full/10.1177/23998083231219048}{\textit{Environment and Planning B}} \enspace | \enspace \href{https://github.com/MiguelGarcaoSilva/cml_synthetic_demo}{\texttt{GitHub}} \\[4pt]
