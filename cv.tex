...
\begin{center}
\textsc{Email:} \href{mailto:miguelgarcaosilva@gmail.com}{miguelgarcaosilva@gmail.com} \hspace{0.7cm}
\textsc{LinkedIn:} \href{https://www.linkedin.com/in/miguelgarcaosilva/}{miguelgarcaosilva}  \hspace{0.7cm}
\textsc{GitHub:}  \href{https://github.com/miguelgarcaosilva}{miguelgarcaosilva} \hspace{0.7cm}
\textsc{Scholar:} \href{https://scholar.google.com/citations?user=d2wE68gAAAAJ}{miguelgarcaosilva}
\end{center}
\medskip
...
\textsc{Present} &
\begin{itemize}[leftmargin=*, itemsep=1pt, topsep=0pt, partopsep=0pt]
  \item Co-led the design of a production AI pipeline that automates custom cable design for a global automotive cable manufacturer, replacing a 16-week / $\sim$€10k physical prototype-and-lab cycle with a 1-day / $\sim$€1.8k software workflow ($\sim$80$\times$ faster, 5--10$\times$ cheaper per RFP).
  \item Formulated the surrogate-modeling layer: a Graph Neural Network with calibrated uncertainty, trained on multiphysics simulation history, turning hours of physics solves into millisecond inference.
  ...
  \item Designed the agent architecture for the LLM engineer assistant (OpenAI SDK): the specialist agents it can call (generation, simulation, optimization, proposal), the tools each exposes, and how the orchestrator routes intent.
\end{itemize} \\
& \\[-6pt]
...
\begin{itemize}[leftmargin=*, itemsep=1pt, topsep=0pt, partopsep=0pt]
  ...
  \item Mined motifs in multivariate time series; built \texttt{msig} to evaluate their statistical significance.
\end{itemize} \\
& \\[-6pt]
...
\textsc{2024} & 
\begin{itemize}[leftmargin=*, itemsep=1pt, topsep=0pt, partopsep=0pt]
  \item Invited TA delivering 140+ hours on Information Retrieval (Python) and Database Systems (SQL) to 300+ students; 4.5/5 average rating across three semesters.
\end{itemize} \\
& \\[-6pt]
...
\section{Education}
\begin{tabular}{rl}
\textsc{2021 -- 2026} & \textbf{PhD in Computer Science} \\
& \textit{Faculty of Sciences University of Lisbon}, Portugal \\[1ex]
...
\textbf{Applied AI:} Surrogate Modeling · Multi-Objective Optimization · Time-Series Modeling · Uncertainty Quantification

\textbf{LLM \& Agents:} OpenAI SDK · Tool Use · Structured Outputs · Orchestration

\textbf{Engineering \& MLOps:} FastAPI · Pydantic · Docker · CI/CD (GitHub Actions) · MLflow · Async Pipelines
...
\textsc{2026} & \textbf{On Why and How Statistical Significance Criteria Can Guide Multivariate Time Series Motif Analysis} \hfill \href{https://doi.org/10.1016/j.patrec.2026.04.020}{\textit{Pattern Recognition Letters}} \enspace | \enspace \href{https://pypi.org/project/msig/}{\texttt{PyPI: msig}} \enspace | \enspace \href{https://github.com/MiguelGarcaoSilva/msig}{\texttt{GitHub}} \\[4pt]

\textsc{2025} & \textbf{Cutting through the noise: Explaining residuals in multivariate time series with motif analysis} \hfill \href{https://www.sciencedirect.com/science/article/pii/S0031320325005606\#sec5}{\textit{Pattern Recognition}} \enspace | \enspace \href{https://github.com/MiguelGarcaoSilva/motifsinresidual}{\texttt{GitHub}} \\[4pt]

\textsc{2025} & \textbf{The Next Motif: Tapping into Recurrence Dynamics and Precursor Signals to Forecast Events of Interest} \hfill \href{https://link.springer.com/chapter/10.1007/978-3-032-15535-1_2}{\textit{Springer (book chapter)}} \enspace | \enspace \href{https://github.com/MiguelGarcaoSilva/motifpred}{\texttt{GitHub}} \\[4pt]

\textsc{2024} & \textbf{A Comprehensive Survey on Biclustering-based Collaborative Filtering} \hfill \textit{ACM Computing Surveys} \\[4pt]

\textsc{2024} & \textbf{Actionable descriptors of spatiotemporal urban dynamics from large-scale mobile data} \hfill \href{https://journals.sagepub.com/doi/full/10.1177/23998083231219048}{\textit{Environment and Planning B}} \enspace | \enspace \href{https://github.com/MiguelGarcaoSilva/cml_synthetic_demo}{\texttt{GitHub}} \\[4pt]

\textsc{2022} & \textbf{Water consumption pattern analysis using biclustering: When, why and how} \hfill \href{https://www.mdpi.com/2073-4441/14/12/1954}{\textit{MDPI Water}} \\
