...
\begin{center}
\href{mailto:miguelgarcaosilva@gmail.com}{miguelgarcaosilva@gmail.com} \enspace $\bullet$ \enspace
\href{https://www.linkedin.com/in/miguelgarcaosilva/}{LinkedIn} \enspace $\bullet$ \enspace
\href{https://github.com/miguelgarcaosilva}{GitHub} \enspace $\bullet$ \enspace
\href{https://scholar.google.com/citations?user=d2wE68gAAAAJ}{Google Scholar}
\end{center}
\medskip
...
\textsc{2026} & {\small\textbf{On Why and How Statistical Significance Criteria Can Guide Multivariate Time Series Motif Analysis}} \\
...
\textsc{2025} & {\small\textbf{Cutting through the noise: Explaining residuals in multivariate time series with motif analysis}} \\
...
\textsc{2025} & {\small\textbf{The Next Motif: Tapping into Recurrence Dynamics and Precursor Signals to Forecast Events of Interest}} \\
...
\textsc{2024} & {\small\textbf{A Comprehensive Survey on Biclustering-based Collaborative Filtering}} \\
 & \href{https://doi.org/10.1145/3674723}{\textit{ACM Computing Surveys}} \\[6pt]

\textsc{2024} & {\small\textbf{Actionable descriptors of spatiotemporal urban dynamics from large-scale mobile data}} \\
...
\textsc{2022} & {\small\textbf{Water consumption pattern analysis using biclustering: When, why and how}} \\
