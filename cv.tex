...
My work centers on scalable and interpretable machine learning methods for time series modeling and pattern discovery, with applications in behavioral, mobility, and utility data. It aims to extract actionable insights from complex temporal patterns, emphasizing interpretability, scalability, and practical impact.
...
\textbf{Areas of Focus:}  · Machine Learning · Deep Learning  · Pattern Mining · Time Series Analysis 
...
\textsc{2021 --} & \textbf{Junior Researcher} at \textsc{LASIGE} \\
\textsc{2022} & 
\begin{itemize}[leftmargin=*,  itemsep=1pt]
  \item Improved movie recommendation accuracy by 6.4\% using biclustering-enhanced collaborative filtering.
  \item Authored a survey published in ACM Computing Surveys, a leading CS journal.
\end{itemize} \\
...
\textsc{Expected 2025} & \textit{Faculty of Sciences University of Lisbon}, Portugal \\[1ex]
...
\textsc{2025} & \textbf{Deep Learning Specialization} \\
& \textit{Coursera - DeepLearning.AI} \\ 
...
\textsc{2025} & \textbf{Next-Motif: Predicting Irregular Pattern Recurrence in Time Series} \hfill \href{https://github.com/MiguelGarcaoSilva/motifpred}{\texttt{GitHub}} \\ [0.25ex]
...
%\textsc{2025} & \textbf{Deep Learning From Scratch} \hfill \href{https://github.com/MiguelGarcaoSilva/FNN-Numpy}{\texttt{GitHub}} \\ [0.25ex]
%& \quad \hangindent=1em \hangafter=1 Built vectorized NumPy implementations of FNNs, CNNs, and LSTMs to solidify understanding of neural network internals. \\[3ex]

%\textsc{2025} & \textbf{LLM-Powered Fashion Assistant} \hfill \href{https://github.com/MiguelGarcaoSilva/WardrobeGPT}{\texttt{GitHub}} \\
%& \quad \hangindent=1em \hangafter=1 Developed a web-based virtual stylist leveraging vision-language models (VLMs) to provide personalized outfit recommendations based on user-uploaded images. \\[3ex]
...
\textbf{Python} · \textbf{SQL} · \textbf{Pandas} · \textbf{Scikit-learn} · \textbf{PyTorch} · \textbf{ETL Pipelines} · \textbf{NumPy} · \textbf{Matplotlib} · \textbf{Git}
